...
ActiveRecord::Schema.define(version: 20130817122701) do
  ...
  add_index "candidatures", ["user_id", "vacancy_id"], name: "index_candidatures_on_user_id_and_vacancy_id", unique: true, using: :btree
  add_index "candidatures", ["user_id"], name: "index_candidatures_on_user_id", using: :btree
